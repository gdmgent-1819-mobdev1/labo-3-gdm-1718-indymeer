...
bad.addEventListener("click", function (event) {
 ...
 array = people[index];
 //like_button = JSON.parse(localStorage.getItem(like_button));
...
array = people[index];
//dislike_button = JSON.parse(localStorage.getItem(dislike_button));
...
next.addEventListener("click", function () {
  ...
  for(i=0; i<like_button.length; i++){
    document.getElementById("text2").innerHTML += like_button[i].name + '<h3>Like:</h3> <br>';
